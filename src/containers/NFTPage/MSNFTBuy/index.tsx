...
const MSNFTBuy = () => {
  ...
  const tUSDTAddress = ''; // USDT address on BSC testnet
  const tMintPrice = 0.05; //NFT Price : 0.1USDT
  // const tNFTContractAddress=''; //tNFTContractAddress on BSC testnet
  const tNFTContractAddress = ''; //tNFTContractAddress on BSC testnet
    ...
    >
      ...
      >
        ...
        >
          ...
          <Typography
            onClick={() => {
              navigator.clipboard.writeText('' + tokenIndex);
            }}
            opacity={'80%'}
            type='headline4'
            className=' absolute top-5 left-5 cliptext'
          >
            #{tokenIndex}
          </Typography>
          ...
          >
            Monsters Syndicate NFT
          </Typography>
          <div
            onClick={() => {
              navigator.clipboard.writeText(tNFTContractAddress);
            }}
            style={{ color: 'black', opacity: '50%' }}
            className=' absolute bottom-0 left-2 cliptext textover'
          >
            {tNFTContractAddress}
          </div>
        </Flex>
      ...
      <Flex
        ...
        className='xs:mb-[28px] xl:mb-[0px] lg:max-w-[600px]'
      >
        <Typography
          type='headline1'
          as='span'
        ...
        <Flex
          ...
          flexDirection={'column'}
          className=' border-[1px] border-gray-500 rounded-lg pr-2 pl-5 py-2 my-1 border-l-4 border-l-green-400'
        >
          <Typography type='headline4' as='span' color='text.primary'>
            Benefit:
          </Typography>
          <Typography type='body1' color='text.read'>
            Holders of Monsters Syndicate NFTs gain exclusive access to private
            social channels, fostering a sense of community and providing a
            platform for networking and sharing insights. Monsters Syndicate NFT
            holders can unlock unique vanity profile pictures and obtain a
            special role within the Discord community, showcasing their status
            as esteemed holders.
          </Typography>
        </Flex>
        <Flex
        ...
        >
          ...
          <Typography type='body1' color='text.read'>
            Each Monsters Syndicate NFT allows the holder to deposit up to 5,000
            USDT.
          </Typography>
        </Flex>
        <Flex
