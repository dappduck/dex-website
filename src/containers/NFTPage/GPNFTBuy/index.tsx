    ...
    >
      ...
      >
        ...
        <Flex
          ...
          flexDirection={'column'}
          className=' border-[1px] border-gray-500 rounded-lg py-2 pl-5 pr-2 my-1 border-l-4 border-l-green-400'
        >
          <Typography type='headline4' as='span' color='text.primary'>
            Benefit:
          </Typography>
          <Typography type='body1' color='text.read' mb='8px'>
            Holders of Generation Prime NFTs enjoy exclusive benefits such as
            extra $MKT tokens as a bonus with each MKT purchase, tax exemption
            on deposits made to CoinAI Pools, extra CoinAI Pool deposit
            allowance of up to 20,000 USDT, governance vote power, access to
            private social channels, and vanity profile pictures and Discord
            role.
          </Typography>
        </Flex>
        ...
        >
          ...
          <Typography type='body1' color='text.read' mb='8px'>
            Each Generation Prime NFT allows the holder to deposit up to 10,000
            USDT.
          </Typography>
        </Flex>
        <Flex
      ...
      >
        ...
        <Typography
          ...
          textColor={'white'}
          type='headline3'
          className=' absolute top-5 right-5 cliptext'
        >
          #{tokenIndex}
        </Typography>
        ...
        <div
          ...
          className=' absolute bottom-0 right-2 cliptext textover'
        >
          {tNFTContractAddress}
        </div>
      </Flex>
