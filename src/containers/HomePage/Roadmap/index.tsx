  ...
  const roadmap = [
    {
      ...
      contentTwo:
        'Staking: Launch of staking platform. An MKT rewarding pool where users can stake their text tokens and harvest more MKT. Introduce of a unique USDT rewarding pool where users can stake their MKT and harvest USDT. Note: The reward of this pool will be provided by CoinAI Trading Protocol.',
      contentThree:
        "Farms : Launch of text Token's farming platform, allowing users to stake their tokens and earn rewards. Introduce of initial farming pools with attractive APYs to incentivize participation. Conduct thorough audits and security checks to ensure the safety of users' funds.",
    },
    {
      name: 'q2',
      precious: 'Q4, 2023',
      ...
      contentTwo:
        'Engaging in strategic partnerships to bring exclusive farming opportunities to the text Token community.',
      contentThree:
        'NFT : Launch of the text Token special edition NFTs and based on the team’s decision possibly an NFT Marketplace, providing a platform for creators to mint and sell unique digital NFTs and assets.',
      contentFourth:
        ' Collaboration with talented artists to curate a diverse collection of text - themed NFTs. Implementing a user-friendly interface for seamless buying, selling, and trading of NFTs.',
      contentFifth:
      ...
      contentSeventh:
        ' Introducing Passive Income elements to the text NFTs, offering interactive experiences and rewards tied to the text special NFTs.',
    },
    {
      name: 'q3',
      precious: 'Q1, 2024',
    ...
    },
    {
      ...
      contentTwo:
        ' Implementing cross-chain compatibility, allowing users to farm and stake their text Tokens on multiple blockchain networks. Introduction of AI yield optimization strategies and automated farming tools, such as bots and apps to enhance user returns.',
      contentThree:
      ...
      <div className='flex max-lg:flex-col justify-between mb-10'>
        <div className='w-5/12 max-lg:w-full'>
          ...
          <Typography type='paragraph1' className='text-read'>
            Embark on an exciting roadmap with text Token: Innovations and
